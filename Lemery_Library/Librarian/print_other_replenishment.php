 ...
 <div class="row">
  <div class="container">
      <center><h6><img src="../assets/img/logo2.png" style="width: 35px;">Lemery Colleges</h6></center>
            ...
            <center><h5>Other Materials Replenishment Report</h5></center>
            <?php
      ...
      if ($date_from!='' && $date_to !='') {
        ...
        if($result->num_rows > 0) {
          ...
          $output.= '<tr>';  
            ...
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["MaterialID"].'</center></td>';
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["MaterialName"].'</center></td>';
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["Description"].'</center></td>';
            $output.='<td id="td_name'.$row["ID"].'"><center>P'.number_format($row["MarkedPrice"],2).'</center></td>';
