...
<head>
  ...
  <title>
    Patrons' Monitoring | Lemery Colleges LMS
  </title>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">Patrons' Monitoring</a>
          ...
          <div class="col-lg-12">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Patrons' Monitoring</h5>
...
<script type="text/javascript" src="../datatables/datatables.min.js"></script>
 ...
 var date_from=document.getElementById("date_from").value;
   ...
   var dataTable1 = $('#tbl_books').DataTable({
    ...
    "ajax" : {
     url:"functions/select_patrons_monitoring.php?"+other_data,
     type:"POST",
     cache:false,
  ...
  function printReport() {
    ...
    var other_data="date_from="+date_from+
                   "&date_to="+date_to;
       window.open("print_monitoring.php?"+other_data, '_blank', 'location=yes,height=1366,width=768,scrollbars=yes,status=yes');
    }
