...
$usertype = $_GET["usertype"];
    ...
    $query = "SELECT `ID`, `UserID`, `LastName`, `FirstName`, `MiddleName`, `Address`, `Gender`, `ContactNo`, `Email`, `Department`, `Course`, `YearLevel`, `Section`, `Photo`, `AcademicYear`, `Semester`, `UserType`, `Position`, `Password`,`Status` FROM `tbl_users` WHERE (`UserType` LIKE '$usertype') AND (`Status` LIKE'')";
...
if ($usertype=='Student') {
 ...
 $sub_array[] = '<div id="td_name'.$row["ID"].'"><center>'.$row["Position"].'</center></div>';	
}
...
require ("../../db_connection/myConn.php");
$usertype = $_GET["usertype"];
 $query = "SELECT `ID`, `UserID`, `LastName`, `FirstName`, `MiddleName`, `Address`, `Gender`, `ContactNo`, `Email`, `Department`, `Course`, `YearLevel`, `Section`, `Photo`, `AcademicYear`, `Semester`, `UserType`, `Position`, `Password` FROM `tbl_users` WHERE (`UserType` LIKE '$usertype')";
