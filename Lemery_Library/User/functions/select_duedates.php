...
if ($date_from!='' && $date_to !='') {
    ...
    $query = "SELECT `ID`, `AcademicYear`, `Semester`, `PatronID`, `PatronName`, `UserType`, `Section_Position`, `ItemID`, `ISBN`, `ItemCategory`,`Title_Name`, `Description`, `DateBorrowed`, `DueDate`, `DateReturned`, `Remarks` FROM `tbl_transactions` WHERE `Remarks` LIKE 'Borrowed' AND `PatronID` LIKE '$patron_id'".$date_filter;
...
require ("../../db_connection/myConn.php");
$patron_id = $_SESSION['UserID'];
 $query = "SELECT `ID`, `AcademicYear`, `Semester`, `PatronID`, `PatronName`, `UserType`, `Section_Position`, `ItemID`, `ISBN`, `ItemCategory`,`Title_Name`, `Description`, `DateBorrowed`, `DueDate`, `DateReturned`, `Remarks` FROM `tbl_transactions` WHERE `Remarks` LIKE 'Borrowed' AND `PatronID` LIKE '$patron_id'";
