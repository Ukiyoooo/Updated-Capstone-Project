...
if ($date_from!='' && $date_to !='') {
    ...
    $query = "SELECT `ID`, `AcademicYear`, `Semester`, `PatronID`, `PatronName`, `UserType`, `Section_Position`, `ItemID`, `ISBN`, `ItemCategory`,`Title_Name`, `Description`, `DateBorrowed`, `DueDate`, `DateReturned`, `Remarks` FROM `tbl_transactions` WHERE `PatronID` LIKE '$patron_id'".$date_filter;
...
function get_all_data($con_str) {
  $patron_id = $_SESSION['UserID'];
require ("../../db_connection/myConn.php");
 $query = "SELECT `ID`, `AcademicYear`, `Semester`, `PatronID`, `PatronName`, `UserType`, `Section_Position`, `ItemID`, `ISBN`, `ItemCategory`,`Title_Name`, `Description`, `DateBorrowed`, `DueDate`, `DateReturned`, `Remarks` FROM `tbl_transactions` WHERE `PatronID` LIKE '$patron_id'";
