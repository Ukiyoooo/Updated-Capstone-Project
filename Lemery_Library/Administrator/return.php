      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="return.php">Clear</a>
...
<script type="text/javascript" src="../datatables/datatables.min.js"></script>
 ...
 <script type="text/javascript" language="javascript">
  ...
  $(document).on("click", "#btn_return", function() {
     ...
     var transaction_id = $(this).data("id");
      var insert_id =$(this).data("itemid");
      var insert_isbn =$(this).data("isbn");
      var insert_category =$(this).data("category");
      var insert_description =$(this).data("description");
      ...
      var other_data = "insert_id="+insert_id+
       ...
       var str_success = '';
            ...
            str_title = "Do you want to return this item? Don't forget to check his/her penalties";
            str_success = "Item has been returned.";
      var apirespnse='';
     ...
     swal({
                            ...
                            cancelButtonClass: "btn"
                                ...
                                if (result.value) {
                                             ...
                                             str_url = 'functions/return_transaction.php?'+other_data;
                                                 // function
                                                  $.ajax({ //start ajax
 ...
 function fetchBorrowed(id) {
   ...
   var dataTable1 = $('#tbl_books').DataTable({
    ...
    "ajax" : {
     url:"functions/select_borrowed_items.php?patroin_id="+id,
     type:"POST",
     cache:false,
