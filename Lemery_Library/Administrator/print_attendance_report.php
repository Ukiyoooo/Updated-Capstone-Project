 ...
 <div class="row">
  <div class="container">
      <center><h6><img src="../assets/img/logo2.png" style="width: 35px;">Lemery Colleges</h6></center>
            ...
            <center><h5>Attendance Report</h5></center>
            <?php
   ...
   <table class="table table-bordered" id="tbl_book_report">
     ...
     require ("../db_connection/myConn.php");
      ...
      if ($date_from!='' && $date_to !='') {
        ...
        $query = "SELECT `ID`, `DateRecorded`, `PatronID`, `PatronName`, `UserType`, `Purpose`, `time_in`, `time_out` FROM `tbl_attendance` ".$date_filter;
        ...
        if($result->num_rows > 0) {
          ...
          $output.= '<tr>';  
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["DateRecorded"].'</center></td>';
            ...
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["Purpose"].'</center></td>';
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["time_in"].'</center></td>';
            $output.='<td id="td_name'.$row["ID"].'"><center>'.$row["time_out"].'</center></td>';
