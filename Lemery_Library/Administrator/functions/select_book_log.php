...
if ($date_from!='' && $date_to !='') {
    ...
    $query = "SELECT `ID`, `Date`, `ISBN`, `Section`, `Title`, `Subject`, `Author`, `Publisher`, `Edition`, `Copyright`, `BeginningInventory`, `Arrivals`, `Borrowed`, `Returned`, `Lost`, `Disposed`, `EndingInventory` FROM `tbl_inventorylogs_books`".$date_filter;


$columns = array("Date","ISBN","Section","Title","Subject","Author","Publisher","Edition","Copyright","BeginningInventory","Arrivals","Borrowed","Returned","EndingInventory");
...
$returned=$row["Returned"];
 ...
 $sub_array[] = '<div id="td_name'.$row["ID"].'"><center>'.$row["Date"].'</center></div>';
