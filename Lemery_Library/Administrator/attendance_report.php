...
<head>
  ...
  <title>
    Attendance Report| Lemery Colleges LMS
  </title>
          ...
          <div class="col-lg-12">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Attendance Report</h5>
...
var date_from=document.getElementById("date_from").value;
   ...
   var dataTable1 = $('#tbl_books').DataTable({
    ...
    "ajax" : {
     url:"functions/select_attendance_report.php?"+other_data,
     type:"POST",
     cache:false,
 ...
 function printReport() {
    ...
    var other_data="date_from="+date_from+
                   "&date_to="+date_to;
       window.open("print_attendance_report.php?"+other_data, '_blank', 'location=yes,height=1366,width=768,scrollbars=yes,status=yes');
    }
