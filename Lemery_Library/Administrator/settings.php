  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="content">
        ...
        <div class="col-lg-12" id="card_registration" >
            <div class="card card-chart">
              <div class="card-header">
           ...
           <div class="col-lg-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Personal Information</h5>
              ...
              <div class="card-body">
                 <h4>Name</h4>
                <span>Last name:</span>
                <input class="form-control" type="text" name="" id="mylastname" value="<?php echo $lastname; ?>">
               <span>First name:</span>
               <input class="form-control" type="text" name="" id="myfirstname" value="<?php echo $firstname; ?>">
               <span>Middle name:</span>
               <input class="form-control" type="text" name="" id="mymiddlename" value="<?php echo $middlename; ?>">
              ...
              <div class="card-footer">
               ...
               <a  class="btn btn-danger" id="btn_save_info"  style="color:white;float: right;margin-bottom: 20px;"> Update</a>
                              </div>
            </div>
          </div>
 ...
 swal({
   ...
   $(document).on("click", "#btn_save_info", function() {
     event.preventDefault();
      ...
      var mymiddlename = document.getElementById("mymiddlename").value;
      ...
      if (mylastname=='' || myfirstname=='') {
        swal({title:"Warning!",text: "Please complete the required fields!", type:"warning"});
        return;
      }


      var other_data = "mylastname="+mylastname+
                       "&mymiddlename="+mymiddlename+
                       "&myfirstname="+myfirstname;    
     swal({
                            customClass: 'swal-wide',
                            title: "Do you want update your name?", 
                            text: "", 
                            type: "question",
                            showCancelButton: true,
                            confirmButtonColor: "#5cb85c", 
                            ...
                            cancelButtonClass: "btn"
                                ...
                                $.ajax({
                                            ...
                                            url:'functions/update_info.php?'+other_data, 
                                            method:"POST",                                            
                                            contentType:false,
                                            cache:false,
                                            processData:false,
                                            ...
                                            success:function(data){   
                                             ...
                                             if(data.includes('200')){
                                              ...
                                              swal({title:"Success!",text: "Your name has been updated. You will be redirected to login page for security purposes.", type:"success"}).then(okay => {
                                                       if (okay) {
                                                        window.location.href = "../logout.php";
                                                      }
                                                       });                                                                
