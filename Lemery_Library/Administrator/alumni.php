      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Alumni List</a>
          ...
          <div class="col-lg-12" id="card_registration" style="display:none;">
            <div class="card">
              <div class="card-header">
                <h5 class="card-category"><a id="btn_close_card" class="btn btn-default" style="color:white;">View List</a> </h5>     
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-category">Alumni List    <a style="color:white; cursor:pointer;" onclick="printqr();" class="btn btn-default">Print QR Code</a></h5>  
...
function fetchUsers(){
   ...
   var dataTable1 = $('#tbl_users').DataTable({
    ...
    "ajax" : {
     url:"functions/select_alumni.php",
     type:"POST",
     cache:false,
...
$(document).on("click", "#btn_alumni", function() {
       ...
       var str_success = '';
            ...
            str_url = 'functions/alumni_to_student.php?userid='+$(this).data("id");;
            str_title = "Do you want to return this alumni to student list?";
            str_success = "Alumni has been successfully returned to Student list.";
 ...
 function printqr(){
        ...
        window.open("printqrcode_alumni.php", '_blank', 'location=yes,height=1366,width=768,scrollbars=yes,status=yes');
